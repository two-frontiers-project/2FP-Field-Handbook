...
To avoid single points of failure, at least two team members must be trained in each core technical task: [sample collection](06-sample-collection.md) (e.g., diving, sediment core extraction), sample preservation (e.g., cryovial handling, buffer use, cold chain protocols), and metadata check-in (e.g., CID assignment, GPS logging, photograph management). This ensures the expedition can proceed even in the event of illness, injury, or gear failure.
